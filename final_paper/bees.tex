...
\begin{document}
	...
	\label{sec:experiments}
		...
		\label{sub:basic_experiment}
			...
			%% I think i discovered a substantial flaw in the experiment:
			%% Amortized, choosing to be altruistic is choosing a fitness of 0.5
			%% Choosing to be selfish has the potential to obtain much higher
