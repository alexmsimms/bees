...
\begin{document}
  ...
  \label{sec:overview}
    ...
    \begin{frame}[t]\frametitle{Abstract}
      \begin{itemize}
    ...
    \label{sub:model}
      ...
      \begin{frame}[t]\frametitle{The Bee model}
        \begin{itemize}
    ...
    \begin{frame}[t]\frametitle{A day in the life of a bee}
  ...
  \label{sec:experiments}
    ...
    \label{sub:hypothesis}
      ...
      \begin{frame}[t]\frametitle{Hypothesis}
    ...
    \label{sub:basic_experiments}
      ...
      \label{ssub:methods}
        ...
        \begin{frame}[t]\frametitle{Methods of the Basic Experiment}
        
            % TODO: basically the same as the ones outlined above
      ...
      \label{ssub:results}
        ...
        \begin{frame}[t]\frametitle{Composition of the Hive Over Time}
            % TODO:
            % Rerun the experiment with the proper activation function
            % Put results here.
      ...
      \label{ssub:discussion}
        \begin{frame}[t]\frametitle{Why are the bees selfish?}
    ...
    \label{sub:hive_fitness}
      ...
      \subsubsection{Discussion} % (fold)
      \label{ssub:discussion}
        % TODO: Add discussion of these results
      % subsubsection discussion (end)
    ...
    \label{sub:recurrent_experiment}
      ...
      \begin{frame}[t]\frametitle{Rationale}
        \begin{itemize}
